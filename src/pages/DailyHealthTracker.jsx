    ...
    <div className="flex flex-col gap-5">
      {isCoachMode ? (
        <Link to={`/profiles/${forId}`}>
          <div className="flex items-center gap-3 bg-brand-50 border border-brand-100 rounded-2xl px-4 py-3 active:bg-brand-100 transition-colors">
            ...
            <div className="flex-1 min-w-0">
              <p className="text-xs font-medium text-brand-500 uppercase tracking-wide">Coach view</p>
              <p className="text-sm font-bold text-brand-900 truncate">{memberName}</p>
            </div>
      ...
      <h1 className="text-2xl font-bold text-gray-900 tracking-tight">Health Log</h1>
